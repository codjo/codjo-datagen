...
public class SQLTableTriggerForSequenceTest extends XslTestCase {
    ...
    protected String getXslTransformer() {
        return "SQLTableTriggerForSequence.xsl";
    }


    @Override
    protected String getEtalon() {
        return "src/test/resources/sql/table_trigger_sequence_etalon.sql";
    }
}
