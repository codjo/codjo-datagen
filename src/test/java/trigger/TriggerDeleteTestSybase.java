...
public class TriggerDeleteTestSybase extends TestCase {
    public void test_generation() throws Exception {
        DOMSource source = toDataSource("src/test/resources/trigger/TriggerDeleteTest.xml");
        Transformer transformer = toTransformer("TriggerDelete.xsl");
    ...
    private String loadEtalon() throws Exception {
        return FileUtil.loadContent(new File("src/test/resources/trigger/TR_DATAGEN_FILES_D_sybase.txt"));
    }
    ...
    private Transformer toTransformer(final String name)
        ...
        return kernel.DomUtil.toTransformer(TriggerDeleteTestSybase.class.getResourceAsStream(
              name));
    }
}
