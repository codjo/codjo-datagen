...
public class TriggerInsertTestSybase extends TestCase {
    public void test_generation() throws Exception {
        DOMSource source = toDataSource("src/test/resources/trigger/TriggerInsertTest.xml");
        Transformer transformer = toTransformer("TriggerInsert.xsl");
    ...
    private String loadEtalon() throws Exception {
        return FileUtil.loadContent(new File("src/test/resources/trigger/TR_DATAGEN_FILES_I_sybase.txt"));
    }
    ...
    private Transformer toTransformer(final String name)
        ...
        return kernel.DomUtil.toTransformer(TriggerInsertTestSybase.class.getResourceAsStream(
              name));
    }
}
